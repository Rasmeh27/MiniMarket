    ...
    public partial class Frm_Proveedores : Form
    {
        ...
        private void SeleccionarItem()
        {
            if (!string.IsNullOrEmpty(Convert.ToString(dgvPrincipal.CurrentRow.Cells["codigo_proveedor"].Value)))
            {
                ...
                txtDistrito.Text = dgvPrincipal.CurrentRow.Cells["codigo_municipio"].Value.ToString();
                ...
                codigoDistrito = Convert.ToInt32(dgvPrincipal.CurrentRow.Cells["codigo_municipio"].Value);
        ...
        {
            codigoDistrito = Convert.ToInt32(dgvPPD.CurrentRow.Cells["codigo_municipio"].Value);
            txtDistrito.Text = Convert.ToString(dgvPPD.CurrentRow.Cells["descripcion_municipio"].Value);
            pnlPPD.Visible = false;
        }
