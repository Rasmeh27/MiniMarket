    ...
    public class DProveedor
    {
        ...
        public string RegistrarProveedor(int opcion, Proveedor proveedor)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add("@codido_tipo_doc_pc", SqlDbType.Int).Value = proveedor.CoditoTipoDocumentoProveedorCliente;
                ...
                Comando.Parameters.Add("@codigo_municipio", SqlDbType.Int).Value = proveedor.CodigoMunicipio;
