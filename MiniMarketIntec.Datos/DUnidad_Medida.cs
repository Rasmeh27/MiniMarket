...
namespace MiniMarketIntec.Datos
{
    ...
    {
        //UM = Unidad Medida
        public string RegistrarUM(int opcion, Unidad_Medida um)
        {
        ...
        public DataTable Seleccionar(string nombreUM)
        {
            SqlConnection sqlConn = new SqlConnection();
            DataTable Tabla = new DataTable();
            SqlDataReader Resultado;
            ...
            {
                sqlConn = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("SP_UM_Seleccionar", sqlConn);
